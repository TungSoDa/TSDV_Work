                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#editEmployeeModal" class="edit" data-toggle="modal">
                                        <svg aria-hidden="true" width="18" height="18" data-toggle="tooltip" title="Edit" data-original-title="Edit" focusable="false" data-prefix="far" data-icon="user-edit" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg-inline--fa fa-user-edit fa-w-20 fa-2x text-info">
                                ...
                                <td>
                                    <a href="#deleteEmployeeModal" class="delete" data-toggle="modal">
                                        <svg aria-hidden="true" width="18" height="18" data-toggle="tooltip" title="Delete" data-original-title="Delete" focusable="false" data-prefix="far" data-icon="user-minus" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg-inline--fa fa-user-minus fa-w-20 fa-2x text-danger">
